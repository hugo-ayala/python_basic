...
print(
    f"I converted {num_1} and {num_2} to strings, if I add them I get:", str(num_1)+str(num_2))
...
print("{} scheduled to begin at {}, and end at {}".format(
    name_of_job, begin_time, end_time))
print("-"*40)
print()
...
last_six_letters = welcome_message[len(welcome_message)-6:]
print(
    f"The last 6 letters of the welcome message:\n'{welcome_message}'\nare: {last_six_letters}")
